...
This block uses feature-barcode sequencing reads to identify which antigen each single cell bound, and how strongly. The headline use case is antigen binding (BEAM- and LIBRA-seq–style experiments), but it works for any barcoded feature, such as surface-protein (CITE-seq) tags.
